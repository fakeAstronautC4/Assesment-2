...
//CODE HERE
 function canWeDeliver (zip_code){
     if(deliveryAreaZipCodes.includes(zip_code)){
...
// CODE HERE
function canWeDeliverTwo (zip_code){
    for(j = 0; j < deliveryAreaZipCodes; j++){
        if(deliveryAreaZipCodes[j] === zip_code){
            console.log('You are eligible for delivery')
        } else{
            console.log('You are not eligible for delivery :(')
        }
...
//CODE HERE
const noDeal = deals[0]['title'].replace('15% Off!', '10% Off')
...
//CODE HERE
const month = deals[1]['desc'].replace('   This deal lasts until the end of March! ', 'This deal lasts until the end of April!')
